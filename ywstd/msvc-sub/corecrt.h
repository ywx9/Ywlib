...
//-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
#ifdef _DEBUG
_ACRTIMP void __cdecl _invalid_parameter(wchar_t const*, wchar_t const*, wchar_t const*, unsigned int, uintptr_t);
#endif
...
__declspec(noreturn) _ACRTIMP void __cdecl _invoke_watson(wchar_t const* _Expression, wchar_t const* _FunctionName,
...
#define __DEFINE_CPP_OVERLOAD_SECURE_FUNC_SPLITPATH(_ReturnType, _FuncName, _DstType, _Src)                          \
  ...
  inline _ReturnType __CRTDECL _FuncName(z_ _DstType const* _Src, _Post_z_ _DstType (&_Drive)[_DriveSize],           \
