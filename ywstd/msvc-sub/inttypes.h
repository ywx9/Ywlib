...
_ACRTIMP intmax_t __cdecl strtoimax(const char*, char**, int);
_ACRTIMP uintmax_t __cdecl strtoumax(const char*, char**, int);
_ACRTIMP intmax_t __cdecl wcstoimax(const wchar_t*, wchar_t**, int);
_ACRTIMP uintmax_t __cdecl wcstoumax(const wchar_t*, wchar_t**, int);
}
#endif
